...
function handleImage(e) {
    ...
    for(let i = 0; i < childEls.length; i++){
        childEls[i].src = "/public/icons/star2.svg";
    }
...
function downloadIset() {
    ...
    const blobContent = new Blob([content], { type: mime });
    const blobContentFset = new Blob([contentFset], { type: mime });
    const blobContentFset3 = new Blob([contentFset3], { type: mime });
    const image = document.querySelector("input[type='file']");
    formData.append('image', image.files[0]);
    formData.append('fileIset', blobContent);
    formData.append('fileFset', blobContentFset);
    formData.append('fileFset3', blobContentFset3);
    ...
    reader.onload = function (event) {
        ...
        img.onload = function () {
            ...
            for(let i = 0; i < parseInt(confidence.l); i++){
                childEls[i].src = "/public/icons/star.svg";
            }
